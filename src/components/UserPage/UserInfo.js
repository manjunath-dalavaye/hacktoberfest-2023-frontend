      ...
      <Container fixed sx={{overflowY:'auto', marginBottom: 20}} >
        <Grid container spacing={2} sx={{marginTop: "50px"}}>
          <Grid item xs={6} md={4} container justify="center" alignItems="center" textAlign="center">
            ...
            <Avatar alt="profile pic" variant='rounded' src={user?.github_profile_picture} sx={{ position:"absolute", width: 200, height: 200, rotate: "15deg", textAlign: "center", display:"inline-block" }}/>
          </Grid>
          <Grid item xs={6} md={8}>
            <Box>
